...
class ColorThemeData with ChangeNotifier{
 ...
 static SharedPreferences _sharedPreferencesColor;
 ...
 ThemeData get selectedThemeData => _isGreen?_greenTheme:_redTheme;
   ...
   Future<void> createPrefObject()async{
     _sharedPreferencesColor = await SharedPreferences.getInstance();


   }
   void saveThemeToSharedPref(bool value){
     _sharedPreferencesColor.setBool("themeData", value);
   }

   void loadThemeFromSharedPref(){
     _isGreen = _sharedPreferencesColor.getBool("themeData")??true;
   }
}
